...
<div class="content">
    ...
    <div id="sidebar" class="s34">
        <nav class="menu">
            ...
            <a class="nav-item active" href="jobposting.php" class="item active">Add Job Posting</a>
            <a class="nav-item" href="#managepostings">Manage Job Postings</a>
            <a class="nav-item" href="#hireapplicant">Hire an Applicant</a>
            <a class="nav-item" href="#hireapplicant">Accepted Applicants Shortlist</a>
            <a class="nav-item" href="#trackapplicant">Track Applicant</a>
            <a class="nav-item" href="#manageusers">Manage Users</a>
        </nav>
    </div>
    <div id="content">
        <h3>Post a Job</h3>
